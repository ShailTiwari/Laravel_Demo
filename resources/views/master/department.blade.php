...
<x-sidebar/>  
 ...
 <div class="z-depth-top-0 md-modal md-effect-11" id="modal-add">
    ...
    <div class="card-header">
        ...
        <form id="formAccountSettings" method="POST" action="{{ route('save_department') }}" enctype="multipart/form-data">
          @csrf
...
<div class="z-depth-top-0 md-modal md-effect-11" id="modal-edit">
    <div class="card md-content">
      <div class="card-header">
        <div class="card-header-left ">
            <h5>Update department Type</h5>
        </div>
    </div>
         <form id="formAccountSettings" method="POST" action="{{ route('update_department') }}" enctype="multipart/form-data">
          @csrf
            <div class="md-content">
              <div class="col mb-0">
                <label for="emailLarge" class="form-label">Title*</label>
            ...
            $(function () {
                ...
                $(".select_activity").click(function () 
                {
                    ...
                    $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: SITEURL + "/get_department_info",
                            data: {
                               id: id,
                              _token: token
                            },
