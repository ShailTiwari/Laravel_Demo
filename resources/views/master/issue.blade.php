 ...
 <div class="z-depth-top-0 md-modal md-effect-11" id="modal-add">
    ...
    <div class="card-header">
        <div class="card-header-left ">
            <h5>Create issue Type</h5>
        </div>
    </div>
        <form id="formAccountSettings" method="POST" action="{{ route('save_issue') }}" enctype="multipart/form-data">
          @csrf
...
<div class="z-depth-top-0 md-modal md-effect-11" id="modal-edit">
    <div class="card md-content">
      <div class="card-header">
        <div class="card-header-left ">
            <h5>Update issue Type</h5>
        </div>
    </div>
         <form id="formAccountSettings" method="POST" action="{{ route('update_issue') }}" enctype="multipart/form-data">
          @csrf
            <div class="md-content">
              <div class="col mb-0">
                <label for="emailLarge" class="form-label">Title*</label>
